...
/**
 * <p>Java class for SimphonyPosApi_CheckResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SimphonyPosApi_CheckResponse"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Checks" type="{http://micros-hosting.com/EGateway/}ArrayOfSimphonyPosApi_CheckSummaryEx" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "SimphonyPosApi_CheckResponse", propOrder = {
    "operationalResult",
    "checks"
})
public class SimphonyPosApiCheckResponse {

    @XmlElement(name = "OperationalResult")
    protected SimphonyPosApiOperationalResult operationalResult;
    @XmlElement(name = "Checks")
    protected ArrayOfSimphonyPosApiCheckSummaryEx checks;
     ...
     * @return
     *     possible object is
     *     {@link ArrayOfSimphonyPosApiCheckSummaryEx }
     *     
     */
    public ArrayOfSimphonyPosApiCheckSummaryEx getChecks() {
        return checks;
    }
     ...
     *     
     */
    public void setChecks(ArrayOfSimphonyPosApiCheckSummaryEx value) {
        this.checks = value;
    }
